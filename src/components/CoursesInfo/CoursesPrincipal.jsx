  ...
  return (
    <div className="px-6 mb-48">
      ...
      <div className="flex justify-center items-center">
        <div className="max-sm:carousel max-sm:carousel-center space-x-4 max-w-sm relative md:space-x-0 md:max-w-[1300px] md:mx-auto md:grid md:grid-cols-4 md:gap-[10px]">
          {/* First Cards */}
